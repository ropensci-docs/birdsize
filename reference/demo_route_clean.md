...
This is the cleaned version of
...
The cleaning process removes unidentified species and those poorly
sampled by Breeding Bird Survey methods (using the
[filter_bbs_survey](https://docs.ropensci.org/birdsize/reference/filter_bbs_survey.md)
function) and, for these data, filters the `year` to `1994` for rapid
testing.
