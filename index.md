...
of the BBS data. The [bbs-data](https://docs.ropensci.org/birdsize/)
vignette illustrates how to use `birdsize` to generate estimates of
biomass and energy use for a route from the Breeding Bird Survey.
